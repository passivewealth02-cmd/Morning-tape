"""Canonical shared helpers for a Command Center-style xlsx (Google Sheets / Excel).

Copy this whole block to the top of every build_xlsx.py, then add domain lists,
per-sheet builder functions, and a dashboard. Do NOT change the palette or the
helper signatures — every product shares them so the brand stays identical.
"""
