"""Canonical shared marketing helpers (2000x2000 Etsy images, Pillow).

Copy this block to the top of every build_marketing.py, then add: a product crest
(see BRAND.md for the recipe), a KPIS list, a content_dashboard(), per-sheet
content_*() functions, and render_*() functions. Fonts are DejaVu (installed).
"""
from __future__ import annotations
import os, math
from PIL import Image, ImageDraw, ImageFilter, ImageFont

# ---- MARKETING PALETTE (RGB — mirror of the xlsx hex palette) ----
...
# NOTE: app_window() below expects a module-level TABS list (the sidebar tab names)
# and a FILE_LABEL string, plus a content_fn. Define TABS/FILE_LABEL in your product.
